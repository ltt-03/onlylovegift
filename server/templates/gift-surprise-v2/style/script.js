...
const songs = [
  {
    ...
    cover: `${basePath}style/sound/Anh (1).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/In Love x Có Đôi Điều.mp3`,
  },
  {
    title: "Ai Ngoài Anh",
    cover: `${basePath}style/sound/Anh (2).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/Ai Ngoài Anh.mp3`,
  },
  {
    title: "Track 06 x Nơi Này Có Anh",
    cover: `${basePath}style/sound/Anh (3).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/Track 06 x Nơi Này Có Anh.mp3`,
  },
  {
    title: "Lỡ Say Bye Là Bye",
    cover: `${basePath}style/sound/Anh (4).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/Lỡ Say Bye Là Bye.mp3`,
  },
  {
    title: "MISSING YOU",
    cover: `${basePath}style/sound/Anh (5).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/MISSING YOU.mp3`,
  },
  {
    title: "Anh là ai",
    cover: `${basePath}style/sound/Anh (6).jpg`,
    src: window.DYNAMIC_DATA?.music || `${basePath}style/sound/Anh là ai.mp3`,
  },
];
...
function createHeart() {
  ...
  const icons = ["❤", "💖", "💗", "💓", "💕", "🌸"];
  const gifs = [
    `${basePath}style/external/heart-1.gif`,
    `${basePath}style/external/heart-2.gif`,
    `${basePath}style/external/letter-decoration.gif`,
    `${basePath}style/external/heart-4.gif`,
  ];
