...
export default function CreateChristmas() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('templateId', 'christmas');
 ...
 className="container" style={{ padding: '60px 24px', maxWidth: '860px' }}>
      <div className="card" style={{ padding: '40px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '24px' }}>
          ...
          <div>
            <h1 style={{ fontSize: '2rem', margin: 0 }}>Thiệp Giáng Sinh Động</h1>
            <p style={{ color: 'var(--color-text-light)', margin: '4px 0 0', fontSize: '0.95rem' }}>
              Mẫu thiệp chúc mừng Giáng Sinh lung linh diệu kỳ.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group" style={{ marginBottom: '24px' }}>
            ...
            <textarea
              ...
              placeholder="Cậu đẹp theo cách của riêng cậu..."
